...
export const CITIES: CityEntry[] = [
  // ——— EASY ———
  {
    id: "paris", name: "Paris", country: "France", tier: "easy", emoji: "🗼",
    clues: [
  ...
  {
    id: "london", name: "London", country: "United Kingdom", tier: "easy", emoji: "🎡",
    clues: [
  ...
  {
    id: "new-york", name: "New York", country: "United States", tier: "easy", emoji: "🗽",
    clues: [
  ...
  {
    id: "tokyo", name: "Tokyo", country: "Japan", tier: "easy", emoji: "🏮",
    clues: [
  ...
  {
    id: "rome", name: "Rome", country: "Italy", tier: "easy", emoji: "🏛️",
    clues: [
  ...
  {
    id: "sydney", name: "Sydney", country: "Australia", tier: "easy", emoji: "🛶",
    clues: [
  ...
  {
    id: "cairo", name: "Cairo", country: "Egypt", tier: "easy", emoji: "🐪",
    clues: [
  ...
  {
    id: "rio", name: "Rio de Janeiro", country: "Brazil", tier: "easy", emoji: "🎭",
    clues: [
  ...
  // ——— MEDIUM ———
  {
    id: "amsterdam", name: "Amsterdam", country: "Netherlands", tier: "medium", emoji: "🚲",
    clues: [
  ...
  {
    id: "barcelona", name: "Barcelona", country: "Spain", tier: "medium", emoji: "🦎",
    clues: [
  ...
  {
    id: "istanbul", name: "Istanbul", country: "Turkey", tier: "medium", emoji: "⛵",
    clues: [
  ...
  {
    id: "dubai", name: "Dubai", country: "United Arab Emirates", tier: "medium", emoji: "🏗️",
    clues: [
  ...
  {
    id: "singapore", name: "Singapore", country: "Singapore", tier: "medium", emoji: "🦁",
    clues: [
  ...
  {
    id: "san-francisco", name: "San Francisco", country: "United States", tier: "medium", emoji: "🌉",
    clues: [
  ...
  {
    id: "venice", name: "Venice", country: "Italy", tier: "medium", emoji: "🛥️",
    clues: [
  ...
  {
    id: "prague", name: "Prague", country: "Czech Republic", tier: "medium", emoji: "🏰",
    clues: [
  ...
  // ——— HARD ———
  {
    id: "reykjavik", name: "Reykjavik", country: "Iceland", tier: "hard", emoji: "🌋",
    clues: [
  ...
  {
    id: "marrakesh", name: "Marrakesh", country: "Morocco", tier: "hard", emoji: "🕌",
    clues: [
  ...
  {
    id: "kyoto", name: "Kyoto", country: "Japan", tier: "hard", emoji: "⛩️",
    clues: [
  ...
  {
    id: "cusco", name: "Cusco", country: "Peru", tier: "hard", emoji: "🦙",
    clues: [
  ...
  {
    id: "tallinn", name: "Tallinn", country: "Estonia", tier: "hard", emoji: "🛡️",
    clues: [
  ...
  {
    id: "cartagena", name: "Cartagena", country: "Colombia", tier: "hard", emoji: "🏴‍☠️",
    clues: [
  ...
  {
    id: "luang-prabang", name: "Luang Prabang", country: "Laos", tier: "hard", emoji: "🧡",
    clues: [
  ...
  {
    id: "valparaiso", name: "Valparaíso", country: "Chile", tier: "hard", emoji: "🎨",
    clues: [
